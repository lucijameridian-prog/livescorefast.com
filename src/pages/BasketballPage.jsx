...
export default function BasketballPage() {
  ...
  const grouped = filtered.reduce((acc, g) => {
    ...
    const name = g.strLeague || 'Basketball'
  ...
  return (
    <div>
      <h1 className="text-xl font-bold text-white mb-4">🏀 Basketball</h1>
      <div className="mb-4">
      ...
      <div className="flex gap-4">
        <div className="hidden lg:block w-56 flex-shrink-0">
          <SportSidebar sport="basketball" selected={selectedLeague} onSelect={setSelectedLeague} />
        </div>
